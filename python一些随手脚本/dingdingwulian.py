...
def getHtml(url, loadmore=False, waittime=5):
    ...
    if loadmore:
        while num < 100:
            num += 1
            try:
                issue = '//*[@id="root"]/div/main/div/div/div[1]/div/div[1]/div[4]/div[2]/span[2]'
...
getHtml('https://alicert.taobao.com/exam/test?sid=_79659071015153&tenantName=ecpc_tenant_dingding&sst=1HyPyNjYrVSyviO14d3qkMTn%2FmU3yU0s46uY8q4PBmuC7vbsa5K6yBDpiGOtCmQf', True, 2)
